  ...
  return (
    ...
    <div className='hero' id='home'>
        {/* <div className='header'>
            ...
            {
              isSmallDevice? <div style={{marginTop:'0.3em'}}><svg xmlns="http://www.w3.org/2000/svg" width="1.7em" height="1.7em" viewBox="0 0 24 24"><path fill="white" d="M3 18v-2h18v2zm0-5v-2h18v2zm0-5V6h18v2z"></path></svg></div>:
              <div className='menu'>
              <Link to='/'>Home</Link>
        ...
        <Link to='#about' smooth><div className='move-down'>
