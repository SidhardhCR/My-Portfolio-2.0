          ...
          <div className="flex flex-col md:flex-row justify-between md:mr-72 items-center">
              ...
              <div className="flex gap-8 items-center pb-8 md:pb-0">
                <div className='flex flex-col'>
                  ...
                  <div className="flex gap-4 pt-8 md:pt-">
                    <a href='https://www.facebook.com/sidhardh.cr'><svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24">
                    ...
                    <a href="https://x.com/Sidhardh_CR"><svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 16 16">
                    ...
                    <a href="https://www.instagram.com/_sidhardh_c_r_/"><svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 1024 1024">
                    ...
                    <a href="https://www.linkedin.com/in/sidhardh-cr-9a34b0271/"><svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24">
                    ...
                    <a href="https://github.com/SidhardhCR"><svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 16 16">
            ...
            <div className="mt-8 md:mt-0 pb-8 text-center md:text-left">
              ...
              <div className="flex md:flex-row gap-2 justify-center md:justify-start">
                <a className='' href="mailto:sidhardhcr007@gmail.com"><h5 className="mont text-white text-lg md:text-[20px] underline decoration-[#571DB5] underline-offset-[15px]">
